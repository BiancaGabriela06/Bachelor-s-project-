    ...
    return (
        <>
         ...
         {rentBikesDetails.Photo !== null ? (
            ...
            <Grid item xs={6}>
                <img src={bike} alt="Rent Bikes" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </Grid>
        )}
        ...
        <Grid item xs={6}>
            <Card style={{ height: "100%", width: "1080px", padding: "20px" }}>
                <CardContent>
                    ...
                    <Button href={rentBikesDetails.Link_Map}>Use Google Maps</Button>
...
const RestaurantComponent = ({localRestaurantDetails}) => {
    ...
    <div style={{ width: "514px", margin: "16px" }}>
    <Grid container>
       {localRestaurantDetails.Photo !== null ? (
            <Grid item xs={6}>
                <img src={localRestaurantDetails.Photo} alt="Rent Bikes" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </Grid>
        ) : (
            <Grid item xs={6}>
                <img src={restaurant} alt="Rent Bikes" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </Grid>
        )}
        <Grid item xs={6}>
            <Card style={{ height: "100%", width: "1080px", padding: "20px" }}>
